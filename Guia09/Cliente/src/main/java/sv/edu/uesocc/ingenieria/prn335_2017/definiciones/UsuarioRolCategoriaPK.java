 ...
 */
package sv.edu.uesocc.ingenieria.prn335_2017.definiciones;
...
public class UsuarioRolCategoriaPK implements Serializable {
    ...
    public String toString() {
        return "sv.edu.uesocc.ingenieria.prn335_2017.definiciones.UsuarioRolCategoriaPK[ idUsuario=" + idUsuario + ", idCategoria=" + idCategoria + ", idRol=" + idRol + " ]";
    }
